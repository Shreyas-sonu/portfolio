(function (b) {
  ...
  a.fn = b.Accordion.prototype = {
    ...
    loadOptions: function (c) {
      this.opts = b.extend(
        {},
        b.extend(true, {}, b.Accordion.opts),
        this.$element.data(),
        c
      );
    },
    setCallback: function (j, h, d) {
      ...
      if (m && typeof m[j] != "undefined") {
        ...
        for (var f = 0; f < g; f++) {
          ...
          if (
            c == "tools." + b.Accordion.NAME ||
            c == b.Accordion.NAME + ".tools"
          ) {
            var l = m[j][f].handler;
            k.push(
              typeof d == "undefined" ? l.call(this, h) : l.call(this, h, d)
            );
          }
        }
        if (k.length == 1) {
    ...
    setStatus: function (d) {
      ...
      b.each(c, function (e, f) {
        if (d == "close") {
          f.removeClass("accordion-" + e + "-opened").addClass(
            "accordion-" + e + "-closed"
          );
        } else {
          f.removeClass("accordion-" + e + "-closed").addClass(
            "accordion-" + e + "-opened"
          );
        }
      });
    ...
    scrollTo: function (c) {
      b("html, body").animate({ scrollTop: b(c).offset().top - 50 }, 500);
    },
  };
...
(function (b) {
  ...
  b.Autocomplete.opts = { url: false, min: 2, set: "value" };
  a.fn = b.Autocomplete.prototype = {
    ...
    loadOptions: function (c) {
      this.opts = b.extend(
        {},
        b.extend(true, {}, b.Autocomplete.opts),
        this.$element.data(),
        c
      );
    },
    setCallback: function (j, h, d) {
      ...
      if (m && typeof m[j] != "undefined") {
        ...
        for (var f = 0; f < g; f++) {
          var c = m[j][f].namespace;
          if (
            c == "tools." + b.Autocomplete.NAME ||
            c == b.Autocomplete.NAME + ".tools"
          ) {
            var l = m[j][f].handler;
            k.push(
              typeof d == "undefined" ? l.call(this, h) : l.call(this, h, d)
    ...
    build: function () {
      ...
      this.placement =
        b(document).height() - (this.pos.top + this.elementHeight) <
        this.result.height()
          ? "top"
          : "bottom";
    ...
    lookup: function () {
      b.ajax({
        ...
        success: b.proxy(function (c) {
          ...
          b.each(
            d,
            b.proxy(function (h, j) {
              var f = b("<li>");
              var g = b('<a href="#" rel="' + j.id + '">')
                .html(j.value)
                .on("click", b.proxy(this.set, this));
              f.append(g);
          ...
          this.result.css({ top: e + "px", left: this.pos.left + "px" });
          this.result.show();
          this.active = false;
        }, this),
      });
    ...
    select: function (f) {
      ...
      var d =
        f === "next"
          ? c.parent().next().children("a")
          : c.parent().prev().children("a");
      if (d.size() === 0) {
    ...
    hide: function (c) {
      if (
        c &&
        (b(c.target).hasClass("autocomplete-in") ||
          b(c.target).hasClass("autocomplete-open") ||
          b(c.target).parents().hasClass("autocomplete-open"))
      ) {
        return;
      }
  ...
  a.fn = b.Buttons.prototype = {
    ...
    getValue: function () {
      return this.opts.type === "segmented"
        ? b(this.opts.target).val().split(",")
        : b(this.opts.target).val();
    },
    setDefault: function (c) {
      if (
        this.opts.type === "segmented" &&
        b.inArray(c.val(), this.value) !== -1
      ) {
        this.setActive(c);
      } else {
        if (
  ...
  a.fn = b.CheckAll.prototype = {
    ...
    setOnStart: function (d, e) {
      ...
      if (
        ...
        (this.setter && b.inArray(c.val(), this.setter) !== -1)
      ) {
        c.prop("checked", true);
        this.setHighlight(c);
      }
...
(function (b) {
  ...
  a.fn = b.Dropdown.prototype = {
    ...
    setCallback: function (j, h, d) {
      ...
      if (m && typeof m[j] != "undefined") {
        ...
        for (var f = 0; f < g; f++) {
          var c = m[j][f].namespace;
          if (
            c == "tools." + b.Dropdown.NAME ||
            c == b.Dropdown.NAME + ".tools"
          ) {
            var l = m[j][f].handler;
            k.push(
              typeof d == "undefined" ? l.call(this, h) : l.call(this, h, d)
    ...
    setPosition: function () {
      ...
      this.$dropdown.css({ position: g, top: i + "px", left: e + "px" });
    },
    show: function () {
    ...
    hide: function (d) {
      if (d) {
        ...
        if (
          c.hasClass("caret") ||
          c.hasClass("dropdown-in") ||
          c.closest(".dropdown-open").size() !== 0
        ) {
          return;
        }
      }
...
(function (b) {
  ...
  a.fn = b.Filterbox.prototype = {
    ...
    loadOptions: function (c) {
      this.opts = b.extend(
        {},
        b.extend(true, {}, b.Filterbox.opts),
        this.$element.data(),
        c
      );
    },
    setCallback: function (j, h, d) {
      ...
      if (m && typeof m[j] != "undefined") {
        ...
        for (var f = 0; f < g; f++) {
          var c = m[j][f].namespace;
          if (
            c == "tools." + b.Filterbox.NAME ||
            c == b.Filterbox.NAME + ".tools"
          ) {
            var l = m[j][f].handler;
            k.push(
              typeof d == "undefined" ? l.call(this, h) : l.call(this, h, d)
    ...
    build: function () {
      ...
      this.$element
        .find("option")
        .each(b.proxy(this.buildListItemsFromOptions, this));
    ...
    setScrollTop: function (c) {
      this.$sourceLayer.scrollTop(
        this.$sourceLayer.scrollTop() + c.position().top - 40
      );
    },
    ...
    onItemClick: function (g, f) {
      ...
      this.$element.val(c);
      this.close();
      this.setCallback("select", { id: c, value: h });
    },
    preventBodyScroll: function () {
    ...
    close: function (c) {
      if (
        c &&
        (b(c.target).hasClass("filterbox-toggle") ||
          b(c.target).closest("div.filterbox").size() == 1)
      ) {
        return;
      }
...
(function (b) {
  ...
  a.fn = b.InfinityScroll.prototype = {
    ...
    loadOptions: function (c) {
      this.opts = b.extend(
        {},
        b.extend(true, {}, b.InfinityScroll.opts),
        this.$element.data(),
        c
      );
    },
    setCallback: function (j, h, d) {
      ...
      if (m && typeof m[j] != "undefined") {
        ...
        for (var f = 0; f < g; f++) {
          var c = m[j][f].namespace;
          if (
            c == "tools." + b.InfinityScroll.NAME ||
            c == b.InfinityScroll.NAME + ".tools"
          ) {
            var l = m[j][f].handler;
            k.push(
              typeof d == "undefined" ? l.call(this, h) : l.call(this, h, d)
    ...
    isElementInViewport: function (c) {
      ...
      return (
        d.top >= 0 &&
        d.left >= 0 &&
        d.bottom <= b(window).height() + this.opts.tolerance &&
        d.right <= b(window).width()
      );
    },
  };
...
(function (b) {
  ...
  a.fn = b.Livesearch.prototype = {
    ...
    loadOptions: function (c) {
      this.opts = b.extend(
        {},
        b.extend(true, {}, b.Livesearch.opts),
        this.$element.data(),
        c
      );
    },
    setCallback: function (j, h, d) {
      ...
      if (m && typeof m[j] != "undefined") {
        ...
        for (var f = 0; f < g; f++) {
          var c = m[j][f].namespace;
          if (
            c == "tools." + b.Livesearch.NAME ||
            c == b.Livesearch.NAME + ".tools"
          ) {
            var l = m[j][f].handler;
            k.push(
              typeof d == "undefined" ? l.call(this, h) : l.call(this, h, d)
...
(function (b) {
  ...
  b.Message.opts = { target: false, delay: 10 };
  a.fn = b.Message.prototype = {
    ...
    setCallback: function (j, h, d) {
      ...
      if (m && typeof m[j] != "undefined") {
        ...
        for (var f = 0; f < g; f++) {
          var c = m[j][f].namespace;
          if (
            c == "tools." + b.Message.NAME ||
            c == b.Message.NAME + ".tools"
          ) {
            var l = m[j][f].handler;
            k.push(
              typeof d == "undefined" ? l.call(this, h) : l.call(this, h, d)
    ...
    show: function () {
      ...
      this.$message
        .addClass("open")
        .fadeIn("fast")
        .on("click.tools.message", b.proxy(this.hide, this));
...
(function (b) {
  ...
  b.Modal.NAME = "modal";
  b.Modal.VERSION = "1.0";
  b.Modal.opts = { title: "", width: 500, blur: false };
  a.fn = b.Modal.prototype = {
    ...
    showOnDesktop: function () {
      ...
      if (this.opts.width > d) {
        this.$modal.css({ width: "96%", marginTop: e / 2 - c / 2 + "px" });
        return;
      }
      if (c > e) {
    ...
    close: function (c) {
      if (c) {
        if (
          !b(c.target).hasClass("modal-close-btn") &&
          c.target != this.$modalClose[0] &&
          c.target != this.$modalBox[0]
        ) {
          return;
        }
        c.preventDefault();
...
(function (b) {
  ...
  a.fn = b.NavigationFixed.prototype = {
    ...
    loadOptions: function (c) {
      this.opts = b.extend(
        {},
        b.extend(true, {}, b.NavigationFixed.opts),
        this.$element.data(),
        c
      );
    },
    setCallback: function (j, h, d) {
      ...
      if (m && typeof m[j] != "undefined") {
        ...
        for (var f = 0; f < g; f++) {
          var c = m[j][f].namespace;
          if (
            c == "tools." + b.NavigationFixed.NAME ||
            c == b.NavigationFixed.NAME + ".tools"
          ) {
            var l = m[j][f].handler;
            k.push(
              typeof d == "undefined" ? l.call(this, h) : l.call(this, h, d)
...
(function (b) {
  ...
  a.fn = b.NavigationToggle.prototype = {
    ...
    loadOptions: function (c) {
      this.opts = b.extend(
        {},
        b.extend(true, {}, b.NavigationToggle.opts),
        this.$element.data(),
        c
      );
    },
    setCallback: function (j, h, d) {
      ...
      if (m && typeof m[j] != "undefined") {
        ...
        for (var f = 0; f < g; f++) {
          var c = m[j][f].namespace;
          if (
            c == "tools." + b.NavigationToggle.NAME ||
            c == b.NavigationToggle.NAME + ".tools"
          ) {
            var l = m[j][f].handler;
            k.push(
              typeof d == "undefined" ? l.call(this, h) : l.call(this, h, d)
...
(function (b) {
  ...
  b.Tabs.NAME = "tabs";
  b.Tabs.VERSION = "1.0";
  b.Tabs.opts = { equals: false, active: false };
...
(function (a) {
  ...
  a.Textfit.opts = { min: "10px", max: "100px", compressor: 1 };
...
(function (b) {
  ...
  a.fn = b.Upload.prototype = {
    ...
    load: function () {
      ...
      this.$placeholdler = b('<div class="tools-droparea-placeholder" />').text(
